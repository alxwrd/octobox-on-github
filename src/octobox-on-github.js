function isElementOfTag(element, tag) {
    console.log(element)
...
var notification = document.querySelectorAll('.notification-indicator')
notification.forEach((element) => {
    if (isElementOfTag(element, "a")) {
        element.href = 'https://octobox.io/'
        element.target = 'https://octobox.io/'
    };
});


var notificationIcon = document.querySelectorAll('.octicon-bell')
notificationIcon.forEach((element) => {
    if (isElementOfTag(element, "svg")) {
        ...
        element.setAttribute('viewBox', '0 -2 22 22')
